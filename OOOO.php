...
#popupWindow.active .window-content {
  transform: translateY(0);
    ...
    margin-right: 0; /* Assurez-vous que ça se termine bien au bord droit */
...
<div id="interfacePrincipal">
  <h2>Bienvenue rosa</h2>
  <button id="openWindow">➡️ Voir tableau</button>
  <!-- Tes boutons, champs de recherche, etc. -->
</div>

<!-- Fenêtre en bas (front2.php) -->
<div id="popupWindow">
