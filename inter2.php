...
<main>
  ...
  <div class="container">
    <header class="d-flex margin-left align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto nav ms-auto mb-2 justify-content-center mb-md-0">
        <li><a href="#" class="nav-link px-2 link-secondary">Home</a></li>
        <li><a href="#" class="nav-link px-2">Ajouter</a></li>
        <li><a href="#" class="nav-link px-2">Modifier</a></li>
        <li><a href="#" class="nav-link px-2">Supprimer</a></li>
  ...
  <div class="b-example-divider"></div>                                      <!--etrangers!-->
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="#" class="nav-link px-2 text-white">Ajouter</a></li>
          <li><a href="#" class="nav-link px-2 text-white">Modifier</a></li>
          <li><a href="#" class="nav-link px-2 text-white">Supprimer</a></li>
          <li><a href="#" class="nav-link px-2 text-white">Deconnexion</a></li>
        </ul>
